...
| 606 | [Construct String from Binary Tree](https://github.com/XiaoLyu/LeetCode/blob/master/src/Construct%20String%20from%20Binary%20Tree.java) | easy | String, Tree |
| --- | --------------------------- | ------------ | ------------ |
